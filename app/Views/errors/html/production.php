...
<body><main class="card"><div class="mark"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.5 18A4.5 4.5 0 0 1 7 9a6 6 0 0 1 11.4 2A3.5 3.5 0 1 1 18 18Z"/></svg></div><h1><?= lang('Errors.whoops') ?></h1><p><?= lang('Errors.weHitASnag') ?></p><a class="home" href="/"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m3 11 9-8 9 8"/><path d="M5 10v10h14V10M9 20v-6h6v6"/></svg><span>Return home</span></a></main></body>
</html>
