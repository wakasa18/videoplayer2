...
<style>
  .vault-toolbar{display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;margin:18px 0 20px}.toolbar-links{display:flex;gap:8px;flex-wrap:wrap}.toolbar-link{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--text-dim);text-decoration:none;border:1px solid rgba(139,99,255,.26);padding:8px 10px;border-radius:8px;background:linear-gradient(180deg,rgba(14,22,52,.96),rgba(10,16,40,.96));box-shadow:0 0 0 1px rgba(255,255,255,.02) inset}.toolbar-link:hover,.toolbar-link.active{color:var(--cyan);border-color:var(--cyan);box-shadow:var(--glow-cyan)}.lock-form{margin:0}.lock-link{background:transparent;color:var(--text-dim);font-family:'JetBrains Mono',monospace;font-size:11px;padding:8px 10px}.lock-link:hover{color:var(--red)}
  .summary-strip{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}.summary-card{background:linear-gradient(180deg,rgba(13,20,47,.96),rgba(10,16,40,.96));border:1px solid rgba(66,233,255,.18);border-radius:10px;padding:14px;box-shadow:0 10px 24px rgba(0,0,0,.16)}.summary-label{font-size:10px;text-transform:uppercase;letter-spacing:.1em;color:var(--text-dim)}.summary-value{font-family:'Cormorant Garamond',serif;font-size:25px;margin-top:3px;color:var(--text);text-shadow:0 0 14px rgba(139,99,255,.2)}
  .drive-bar{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 12px}.breadcrumbs{display:flex;align-items:center;gap:6px;min-width:0;overflow:auto;padding:4px 0;scrollbar-width:thin}.breadcrumb-link{flex:none;color:var(--text-dim);text-decoration:none;font-size:12px;padding:6px 8px;border-radius:5px}.breadcrumb-link:hover,.breadcrumb-link.current{color:var(--cyan);background:linear-gradient(180deg,rgba(255,79,216,.14),rgba(66,233,255,.10));box-shadow:var(--glow-cyan)}.breadcrumb-sep{color:#4f5a77;font-size:11px}.view-switch{display:flex;gap:5px;flex:none}.view-button{width:34px;height:32px;background:linear-gradient(180deg,rgba(14,22,52,.96),rgba(10,16,40,.96));border:1px solid rgba(139,99,255,.26);color:var(--text-dim);border-radius:8px;padding:0}.view-button:hover,.view-button.active{color:var(--cyan);border-color:var(--cyan);box-shadow:var(--glow-cyan)}
  ...
  .folder-section{margin-bottom:18px}.section-label{font:10px 'JetBrains Mono',monospace;text-transform:uppercase;letter-spacing:.12em;color:var(--text-dim);margin:0 0 8px}.folder-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.folder-card-shell{position:relative;min-width:0}.folder-card{display:flex;align-items:center;gap:10px;min-width:0;padding:11px 78px 11px 12px;border:1px solid rgba(255,79,216,.18);background:linear-gradient(180deg,rgba(17,25,59,.94),rgba(11,18,42,.96));border-radius:10px;color:var(--text);text-decoration:none;transition:.15s;box-shadow:0 8px 18px rgba(0,0,0,.16)}.folder-card:hover{border-color:var(--cyan);transform:translateY(-1px);box-shadow:var(--glow-cyan)}.folder-icon{font-size:22px;line-height:1;color:var(--gold);filter:drop-shadow(0 0 8px rgba(255,209,102,.25))}.folder-copy{min-width:0}.folder-name{display:block;font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.folder-count{display:block;font:9px 'JetBrains Mono',monospace;color:var(--text-dim);margin-top:2px}.folder-card-actions{position:absolute;right:7px;top:50%;transform:translateY(-50%);display:flex;gap:3px}.folder-card-action{width:30px;height:30px;padding:0;border:1px solid transparent;background:transparent;color:var(--text-dim);font-size:15px}.folder-card-action:hover{border-color:var(--cyan);color:var(--cyan);background:var(--surface)}
  .file-list{list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:9px;position:relative;isolation:isolate}.file-item{display:flex;align-items:center;gap:12px;background:linear-gradient(180deg,rgba(16,24,57,.96),rgba(10,16,40,.96));border:1px solid rgba(139,99,255,.18);border-radius:10px;padding:11px 12px;position:relative;z-index:0;cursor:pointer;animation:fadeInUp .25s ease both;transition:.15s;box-shadow:0 8px 18px rgba(0,0,0,.15)}.file-item:hover,.file-item:focus-visible{border-color:rgba(66,233,255,.55);transform:translateY(-1px);outline:none;box-shadow:var(--glow-cyan)}.file-item.menu-open{z-index:80;border-color:rgba(66,233,255,.55);box-shadow:var(--glow-cyan)}.file-type-badge{flex:none;width:46px;height:40px;border-radius:8px;background:linear-gradient(135deg,rgba(255,79,216,.16),rgba(66,233,255,.10));border:1px solid rgba(66,233,255,.24);display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-size:9px;font-weight:700;color:var(--cyan);overflow:hidden;box-shadow:0 0 18px rgba(66,233,255,.08) inset}.file-meta{flex:1;min-width:0}.file-title-row{display:flex;gap:7px;align-items:center}.file-title{font-size:14px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.favorite-mark{color:var(--gold);font-size:12px;text-shadow:0 0 10px rgba(255,209,102,.35)}.original-name{font-family:'JetBrains Mono',monospace;font-size:10px;color:#7581a4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:2px}.file-desc{font-size:12px;color:var(--text-dim);margin-top:4px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.file-sub{display:flex;align-items:center;gap:7px;margin-top:5px;flex-wrap:wrap}.file-sub-text{font-family:'JetBrains Mono',monospace;font-size:10px;color:var(--text-dim)}.category-tag{font-size:9px;text-transform:uppercase;letter-spacing:.06em;padding:2px 7px;border-radius:20px;border:1px solid var(--hairline);color:var(--text-dim)}
...
shareList.addEventListener('click', async event => {
  ...
  if (copyButton && !copyButton.disabled) {
    ...
    try {
      const endpoint = <?= json_encode(base_url('files/shares')) ?> + '/' + shareId + '/' + (rotate ? 'rotate' : 'link');
