...
<style>
  ...
  @media(max-width:620px){.summary-strip{grid-template-columns:1fr}.filters{grid-template-columns:1fr}.form-grid{grid-template-columns:1fr}.file-item{align-items:flex-start}.file-type-badge{width:40px;height:34px}.action-menu-panel{position:fixed;left:16px;right:16px;top:auto;bottom:16px;width:auto}.toolbar-links{width:100%}.toolbar-link{flex:1;text-align:center}.modal{padding:10px}.preview-frame{height:70vh}}
</style>
</head>
<body>
...
<div class="modal" id="previewModal" aria-hidden="true"><div class="modal-card wide"><div class="modal-head"><h2 id="previewTitle">Preview</h2><button class="modal-close" type="button" data-close-modal>&times;</button></div><iframe class="preview-frame" id="previewFrame" title="File preview"></iframe></div></div>
