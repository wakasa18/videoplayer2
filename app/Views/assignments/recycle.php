...
<header><p class="eyebrow"><?= $mode==='archive'?'Completed Mission Storage':'Recovery Sector' ?></p><h1><?= $mode==='archive'?'Assignment Archive':'Recycle Bin' ?></h1><div class="starline"></div></header>
...
<?php if(!$items): ?><div class="empty-mission"><div><?= $mode==='archive'?'ARCHIVE EMPTY':'RECYCLE BIN EMPTY' ?></div><p>Nothing is stored here right now.</p></div><?php endif; ?>
